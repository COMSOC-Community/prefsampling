...
def impartial_anonymous(
    ...
    In an impartial anonymous culture, every multi-set of votes is equally likely to occur. For instance with 3 voters
    and 2 alternatives, the probability of observing `a > b, a > b, a > b` is 1/4. This probability was
