...
class DidiValidator(Validator):
    ...
    def theoretical_distribution(self, sampler_parameters, all_outcomes) -> dict:
        ...
        if sampler_parameters["num_candidates"] == 2:
            ...
            prob_0_1 = integrate.quad(lambda x: x**(alpha_0-1) * (1 - x)**(alpha_1 - 1), 0.5, 1)[0]
            prob_1_0 = integrate.quad(lambda x: x**(alpha_1-1) * (1 - x)**(alpha_0 - 1), 0.5, 1)[0]
            denominator = prob_1_0 + prob_0_1
            return {
                (0, 1): prob_0_1 / denominator,
                (1, 0): prob_1_0 / denominator
            }
