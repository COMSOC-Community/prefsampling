...
from prefsampling.ordinal.singlecrossing import single_crossing_uniform
...
class SingleCrossingUniformValidator(Validator):
    def __init__(
        self,
        num_voters,
        num_candidates,
        ...
        super(SingleCrossingUniformValidator, self).__init__(
            num_candidates,
            sampler_func=lambda num_samples, num_candidates, num_voters=None: [single_crossing_uniform(num_voters, num_candidates) for _ in range(num_samples)],
            sampler_parameters={"num_voters": num_voters},
            all_outcomes=all_outcomes,
        )
        self.num_voters = num_voters
